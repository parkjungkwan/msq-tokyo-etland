...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
  <link rel="stylesheet" href="<%=application.getContextPath()%>/resources/css/cmm/w3.css">
  ...
  <div id="full_content" class="row content">
    <div id="left_content" class="col-sm-3 sidenav">
      ...
      <div id="srch_grp" class="input-group">
        <input type="text" id="srch_val" class="form-control" placeholder="상품 검색">
...
<script src="<%=application.getContextPath()%>/resources/js/cmp/compo.js"></script>
<script src="<%=application.getContextPath()%>/resources/js/emp/emp.js"></script>
<script src="<%=application.getContextPath()%>/resources/js/cst/cust.js"></script> 
...
<script src="<%=application.getContextPath()%>/resources/js/cmm/utl.js"></script> 
<script>
